...
namespace Collection.Controllers
{
    public class AlbumController : Controller
    {
        ...
        {
            var collectionContext = _context.Albums.Include(a => a.Artist);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ArtistId,PubYear,GenreList")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ArtistId,PubYear,GenreList")] Album album)
        {
            if (id != album.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CollectionContext.Albums'  is null.");
            }
            var album = await _context.Albums.FindAsync(id);
            if (album != null)
            {
